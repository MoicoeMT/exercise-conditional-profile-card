...
function render(variables = {}) {
  ...
  document.querySelector("#widget_content").innerHTML = `<div class="widget">
          ...
          <h2>${variables.lastName === null ? "" : variables.lastName}</h2>
          <h3>${variables.role === null ? "" : variables.role}</h3>
          <h3>${variables.country === null ? "" : variables.country}</h3>
          <h3>${variables.city === null ? "" : variables.city}</h3>
          <ul class="${variables.socialMediaPosition}">
            ...
            <li><a href="https://linkedin.com/${
              variables.tlinkedin === null ? "" : variables.linkedin
